...
class AuctionVehicle(Base):
    ...
    remoteurlfin = Column(String, nullable=True)
    flagToSendEmail = Column(Boolean, nullable=True)  
    flagTranslation = Column(Boolean, nullable=True)   
    beenViewed = Column(Boolean, nullable=True)
    endPrice = Column(Integer, nullable=True)
    ontrPrice = Column(Integer, nullable=True)
